...
describe("Sender and Receiver", function () {
  ...
  it("should CCIP message from sender to receiver", async function () {
    ...
    const gasLimit = 27570 * 110 / 100; // take max out of the all gas usage report (run test first) and increased it by 10%
    const testParams = [0, 50, 67, 99]; // Different iteration values for testing.
