...
[original](https://github.com/smartcontractkit/smart-contract-examples)

I added some global variables to check the dependencies and changed the hardcoded value to one calculated from the maximum gas usage across all iterations.
